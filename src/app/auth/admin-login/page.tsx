      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col">
        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          <Link href="/" className="flex flex-col leading-tight group w-fit">
            ...
            <span className="text-amber-400/60 text-[10px] tracking-[0.2em] uppercase">
              Owner Console
            </span>
          </Link>
      ...
      <div className="flex-1 bg-[#0d0a04] flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden">
        ...
        <div className="w-full max-w-sm relative z-10">
          <Link href="/" className="flex flex-col leading-tight mb-8 lg:hidden">
            ...
            <span className="text-amber-400/60 text-[10px] tracking-[0.2em] uppercase">Owner Console</span>
          </Link>
