...
export default function AdminThreadPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0D1B0E] flex items-center justify-center">
  ...
  if (!thread) {
    return (
      <div className="min-h-screen bg-[#0D1B0E] flex flex-col items-center justify-center gap-4">
        <p className="text-white/50">Thread not found.</p>
        <Link href="/admin/hotel-admin/support" className="text-amber-400 text-sm underline">← Back</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#0D1B0E] flex flex-col max-h-screen">
      {/* Header */}
      <div className="flex items-center gap-3 px-5 py-4 border-b border-white/8 shrink-0">
        <button onClick={() => router.push("/admin/hotel-admin/support")} className="text-white/40 hover:text-white transition-colors">
