...
export default function BookingForm({
  ...
  async function handleBooking() {
    ...
    try {
      ...
      // ── Pay Now / Pay Partial: launch Razorpay ────────────────────────────────
      await loadRazorpay();
  ...
  return (
    ...
    <div className="space-y-5">
      ...
      {!session?.user && !skipLogin && (
        <div className="glass-card rounded-3xl p-6 border border-amber-500/20">
          <p className="text-white font-semibold text-sm mb-1">Sign in before booking</p>
          <p className="text-white/40 text-xs mb-4">Save your booking to your account so you can view or cancel it anytime</p>

          {/* Benefits */}
          <ul className="space-y-1.5 mb-5">
            <li className="flex items-center gap-2 text-xs text-white/55">
              <CheckCircle className="w-3.5 h-3.5 text-amber-400 shrink-0" />
              View &amp; cancel your bookings anytime
            </li>
            <li className="flex items-center gap-2 text-xs text-white/55">
              <CheckCircle className="w-3.5 h-3.5 text-amber-400 shrink-0" />
              Booking confirmation on WhatsApp &amp; email
            </li>
            <li className="flex items-center gap-2 text-xs text-white/55">
              <CheckCircle className="w-3.5 h-3.5 text-amber-400 shrink-0" />
              Faster check-in with saved guest ID
            </li>
            <li className="flex items-center gap-2 text-xs text-white/55">
              ...
              <span>Name &amp; email auto-filled <span className="text-white/30">(Google sign-in only)</span></span>
            </li>
          </ul>
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-[#0f1f11] px-3 text-xs text-white/20">or</span>
            </div>
          </div>
          ...
          >
            ⚠️ Book without account — you won't be able to view or cancel this booking later
          </button>
        </div>
      )}
